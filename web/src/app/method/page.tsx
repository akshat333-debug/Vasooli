...
const AI_TABLE = [
  ...
  ["Draft the customer nudge", "Claude Haiku", true, "Tone and phrasing. Drafted only — never sent."],
    ...
    <div className="mx-auto max-w-[860px] px-5 py-8 sm:px-8 sm:py-12">
      ...
      <section className="mb-10">
        ...
        <p className="mb-5 text-[14px] text-ink-mute">
          A language model decides how to talk to a customer. It never decides
